export default function SneakerGuide() {
  ...
  <p className="text-gray-400">More Sneaker Guides:</p>

  <ul className="space-y-1 text-green-400">
    <li><a href="/best-sneakers-to-resell">Best Sneakers to Resell</a></li>
    <li><a href="/sneaker-arbitrage-guide">Sneaker Arbitrage Guide</a></li>
    <li><a href="/best-places-to-buy-sneakers-cheap">Best Places to Buy Sneakers Cheap</a></li>
  </ul>
</div>