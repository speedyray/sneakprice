  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-neutral-950 to-neutral-900 px-6 py-10 text-white">
      <div className="mx-auto max-w-[1200px] space-y-8">
        <div className="flex flex-col gap-4 rounded-[32px] border border-neutral-800 bg-neutral-900/70 px-8 py-6 shadow-[0_10px_50px_rgba(0,0,0,0.45)] md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.4em] text-neutral-400">
              Buyer portal
            </p>
            <h1 className="mt-2 text-4xl font-bold tracking-tight">Reserved buyers only</h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link
              href="/marketplace"
              className="rounded-full border border-emerald-500/60 bg-emerald-500/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-emerald-100 transition hover:bg-emerald-500/30"
            >
              Browse listings
            </Link>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {listings.map((listing) => {
            ...
            return (
              <article
                key={listing.id}
                className="flex h-full flex-col justify-between rounded-3xl border border-neutral-800 bg-neutral-900/50 p-5"
              >
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-sm text-neutral-300">Size {listing.size}</p>
                  </div>
                </div>
